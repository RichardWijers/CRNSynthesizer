...
println("Baseline: Generated $(length(molecules)) unique molecules in $(elapsed_time) seconds.")
...
println("With ValidSMILES constraint: Generated $(length(molecules)) molecules in $(elapsed_time) seconds.")
...
elapsed_time = @elapsed begin
    settings = SynthesizerSettings(
        ...
        max_depth = max_depth,
        options = Dict{Symbol, Any}(
            :disable_valid_smiles => true,
        ),
    )
    molecules = synthesize_molecules(atoms, settings)
end
println("Without ValidSMILES constraint: Generated $(length(molecules)) molecules in $(elapsed_time) seconds.")
...
println("Baseline: Generated $(length(candidates)) unique reactions in $(elapsed_time) seconds.")
...
println("With BalancedReaction and Ordered constraint: Generated $(length(candidates)) reactions in $(elapsed_time) seconds.")
...
elapsed_time = @elapsed begin
    settings = SynthesizerSettings(
        ...
        max_depth = max_depth,
        options = Dict{Symbol, Any}(
            :disable_balanced_reaction => true,
        ),
    )
    candidates = synthesize_reactions(atoms, settings)
end
println("Without BalancedReaction constraint: Generated $(length(candidates)) reactions in $(elapsed_time) seconds.")
...
elapsed_time = @elapsed begin
    settings = SynthesizerSettings(
        ...
        max_depth = max_depth,
        options = Dict{Symbol, Any}(
            :disable_ordered_molecule_list => true,
        ),
    )
    candidates = synthesize_reactions(atoms, settings)
end
println("Without Ordered constraint: Generated $(length(candidates)) reactions in $(elapsed_time) seconds.")
...
println("Without BalancedReaction and Ordered constraints: Generated $(length(candidates)) reactions in $(elapsed_time) seconds.")
...
# Problem Definition
max_depth = 5
molecules = synthesize_molecules(atoms, SynthesizerSettings(max_programs=100, max_depth=9))
...
reactions = synthesize_reactions(molecules, SynthesizerSettings(max_programs=200, max_depth=8))
